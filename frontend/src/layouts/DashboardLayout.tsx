...
> = {
  ...
  "/live-queue": {
    ...
    subtitle:
      "General Medicine · Real-time patient flow",
  },
  ...
  "/patients": {
    ...
    subtitle:
      "Patient visits · Tokens · Arrival status",
  },
  ...
  "/doctors": {
    ...
    subtitle:
      "Clinical availability · Capacity · Workload",
  },
  ...
  "/forecasting": {
    ...
    subtitle:
      "Live ETA prediction · Confidence · Queue changes",
  },
  ...
  "/audit": {
    ...
    subtitle:
      "Staff actions · Access control · Operational history",
  },
}
                    ...
                    >
                      ...
                      {({
                        ...
                        <>
                          ...
                          {item.auditOnly && (
                            <span className="rounded-full border border-violet-400/15 bg-violet-500/[0.08] px-2 py-1 text-[7px] font-bold uppercase tracking-[0.12em] text-violet-200">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between rounded-xl bg-black/10 px-3 py-2.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <FileClock className="h-3.5 w-3.5 text-violet-200" />
