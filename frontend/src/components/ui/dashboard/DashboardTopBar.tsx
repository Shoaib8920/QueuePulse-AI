      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative flex min-h-[88px] items-center justify-between gap-5 px-5 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            {user && (
              <div className="hidden h-[52px] items-center gap-3 rounded-2xl border border-violet-400/20 bg-[linear-gradient(135deg,rgba(74,32,130,0.72),rgba(31,24,75,0.82))] p-1.5 pr-4 xl:flex">

                {/* INITIALS */}

                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 via-purple-500 to-blue-500 text-[11px] font-bold text-white shadow-[0_8px_20px_rgba(124,58,237,0.25)]">
                ...
                <div className="min-w-0 text-left">
                  ...
                  <p className="max-w-[150px] truncate text-[11px] font-semibold text-white">
                  ...
                  <div className="mt-0.5 flex items-center gap-1">
                    ...
                    <ShieldCheck className="h-3 w-3 shrink-0 text-cyan-300" />

                    <p className="max-w-[150px] truncate text-[9px] text-[#B8C5D8]">
            ...
            <button
              ...
              title="Log out"
              className="group flex h-[52px] items-center justify-center gap-2 rounded-2xl border border-rose-400/20 bg-rose-500/[0.06] px-4 text-[10px] font-semibold text-rose-100 shadow-[0_14px_30px_rgba(0,0,0,0.20)] transition-all duration-300 hover:border-rose-400/40 hover:bg-rose-500/[0.12]"
            >
